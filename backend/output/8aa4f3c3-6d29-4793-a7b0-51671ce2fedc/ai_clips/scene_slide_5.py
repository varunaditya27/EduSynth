...
class SlideScene_5(Scene):
    def construct(self):
        ...
        bullets = VGroup()
        b0 = Text("Law 1: Inertia resists change", font_size=36)
        b0.next_to(title, DOWN, buff=1.0)
        bullets.add(b0)
        b1 = Text("Law 2: F = ma", font_size=36)
        b1.next_to(title, DOWN, buff=1.6)
        bullets.add(b1)
        b2 = Text("Law 3: Action-Reaction pairs", font_size=36)
        b2.next_to(title, DOWN, buff=2.2)
        bullets.add(b2)

        self.wait(0.2)
        self.play(FadeIn(b0), run_time=2.8108)
        self.wait(0.2)
        self.play(FadeIn(b1), run_time=2.8108)
        self.wait(0.2)
        self.play(FadeIn(b2), run_time=2.8108)
        self.wait(0.5)
